...
- `references/pen-format-spec.md` — Complete .pen format specification with all property types
- `references/mcp-tools-guide.md` — Detailed MCP tool reference with usage examples
