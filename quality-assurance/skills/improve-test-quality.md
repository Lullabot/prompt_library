...
description: >-
  Improve test quality using mutation testing analysis. Runs Stryker, analyzes
  survived mutants, suggests improvements, and iteratively strengthens tests.
date: '2026-05-16'
layout: markdown.njk
...
changelog:
  - date: '2026-05-18'
    summary: Added prompt-library metadata so the skill renders on the public site
tags:
  - mutation testing
  - stryker
  - testing
