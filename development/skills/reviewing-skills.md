...
description: >-
  Reviews a Claude Code skill against skill-authoring best practices and
  produces a prioritized, non-blocking report. Use when creating, editing, or
  reviewing a SKILL.md, a skill's meta.yml, or a skill directory, or when asked
  whether a skill follows best practices.
date: '2026-06-11'
layout: markdown.njk
...
changelog:
  - date: '2026-06-11'
    summary: >-
      ...
      produces a prioritized, non-blocking report.
tags:
  - skills
  - authoring
  - best practices
