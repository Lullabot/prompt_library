...
description: >-
  Write or improve a pull request or merge request description so a reviewer can
  act on it without reconstructing your reasoning from the diff. Use when
  opening a PR/MR, when asked to draft or rewrite a PR description or title,
  when filling in a PULL_REQUEST_TEMPLATE, or when a reviewer says a PR lacks
  context. Covers client-repo PRs, Drupal.org merge requests, and open source
  contributions.
date: '2026-08-12'
layout: markdown.njk
...
changelog:
  - date: '2026-09-04'
    summary: >-
      Added guidance for embedding before-and-after screenshots with
      github-attachments
  - date: '2026-08-12'
    summary: >-
      Added guidance to keep PR descriptions plain and free of padding, and made
      the humanizer pass unconditional.
  - date: '2026-08-12'
    summary: >-
      New skill for drafting pull request and merge request descriptions and
      titles, with separate guidance for client repos, Drupal.org merge
      requests, and open source contributions.
tags:
  - pull-requests
  - code-review
  - git
