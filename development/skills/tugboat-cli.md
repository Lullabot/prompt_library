...
changelog:
  - date: '2026-06-09'
    summary: >-
      Added a guide for uploading a file (e.g. an HTML report) into a running
      Tugboat preview, including the stdin/whitespace-split gotchas and
      re-uploading after rebuilds.
tags:
  - tugboat
